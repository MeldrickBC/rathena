...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant2("bPerformBow", SP_PERFORM_BOW);
	export_constant2("bBackstapTeleport", SP_BACKSTAP_TELEPORT);
	...
	export_constant2("Eff_ChangeUndead", SC_CHANGEUNDEAD);
	...
	export_constant(SC_BOSSFIND);
	export_constant(SC_SPOREEXPLOSION);
	...
	export_constant(SC_WELLFED_INT);
	export_constant(SC_WELLFED_DEX);
	export_constant(SC_WELLFED_LUK);
	export_constant(SC_WELLFED_HP);
	export_constant(SC_WELLFED_SP);
	export_constant(SC_WELLFED_HIT);
	export_constant(SC_WELLFED_FLEE);
	export_constant(SC_WELLFED_CRIT);
	export_constant(SC_WELLFED_ASPD);
	export_constant(SC_WELLFED_ASPD_RATE);
	export_constant(SC_WELLFED_PDODGE);
	export_constant(SC_WELLFED_ATK);
	export_constant(SC_WELLFED_MATK);
	export_constant(SC_WELLFED_DEF);
	export_constant(SC_WELLFED_MDEF);
	export_constant(SC_WELLFED_DEF2);
	export_constant(SC_WELLFED_MDEF2);
	export_constant(SC_WELLFED_HP_REGEN);
	export_constant(SC_WELLFED_SP_REGEN);
	export_constant(SC_WELLFED_CAST);
	export_constant(SC_WELLFED_DELAY);
...
/// Do not modify code above this, since it will be automatically generated by the API again
	export_constant(EFST_FIRST_AID);
