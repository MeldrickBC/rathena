...
#define MAX_SKILL_PRODUCE_DB	500 /// Max Produce DB
...
enum e_skill {
	...
	NV_C_COLLECT = 1100,
	AL_C_HOLYLIGHT_MELEE = 1101,
	AM_SLINGSLIMPOTION = 1110,
	AM_C_CARTUPGRADE = 1112,
	AM_C_CARTCANNON = 1113,
	AM_C_CARTCANNON_APPLE = 1114,
	AM_C_CARTCANNON_COCONUT = 1115,
	AM_C_CARTCANNON_MELON = 1116,
	AM_C_CARTCANNON_PINEAPPLE = 1117,
	AM_C_CARTCANNON_BANANA = 1118,
	AM_C_CARTCANNON_SPORE = 1119,

	ST_C_SHADOWSPELLCAST = 1120,
	HT_C_CLEANCUT = 1195,
	HT_C_FALCONERSMARK = 1196,
	PR_C_SACRUSIMPETUS = 1197,
	PR_C_SACRUSIMPETUS_ATK = 1198,
	HP_C_RADIUSLUCIS = 1200,
	...
	/*SH_C_LATENCYINJECTION = 1500,
	SH_C_CASTDISSECTION = 1501,

	//Weapon Atks
	MONSTER_C_FIREATTACK = 1502,
	MONSTER_C_WATERATTACK = 1503,
	MONSTER_C_WINDATTACK = 1504,
	MONSTER_C_GROUNDATTACK = 1505,
	MONSTER_C_POISONATTACK = 1506,
	MONSTER_C_HOLYATTACK = 1507,
	MONSTER_C_DARKNESSATTACK = 1508,
	MONSTER_C_TELEKINESISATTACK = 1509,
	MONSTER_C_UNDEADATTACK = 1510,

	MONSTER_C_RANDOMATTACK = 1511,
	MONSTER_C_RANGEATTACK = 1512,
	MONSTER_C_SPLASHATTACK = 1513,
	MONSTER_C_PIERCINGATT = 1514,
	MONSTER_C_GUIDEDATTACK = 1515,
	MONSTER_C_BLOODDRAIN = 1516,
	MONSTER_C_DARKPIERCING = 1517,
	MONSTER_C_COMBOATTACK = 1518,
	MONSTER_C_CRITICALSLASH = 1519,
	MONSTER_C_DANCINGBLADE = 1520,
	MONSTER_C_PULSESTRIKE = 1521,
	MONSTER_C_VAMPIRE_GIFT = 1522,
	MONSTER_C_DARKCROSS = 1523,
	//MONSTER_C_DRAGONBREATH = 1524,
	MONSTER_C_HELLJUDGEMENT = 1525,
	MONSTER_C_FIREBREATH = 1526,
	MONSTER_C_ICEBREATH = 1527,
	MONSTER_C_THUNDERBREATH = 1528,
	MONSTER_C_DARKNESSBREATH = 1529,
	MONSTER_C_ACIDBREATH = 1530,	

	MONSTER_C_BLEEDING = 1531,
	MONSTER_C_STUNATTACK = 1532,
	MONSTER_C_BLINDATTACK = 1533,
	MONSTER_C_CURSEATTACK = 1534,
	MONSTER_C_DEADLYCURSE = 1535,
	MONSTER_C_PETRIFYATTACK = 1536,
	MONSTER_C_SILENCEATTACK = 1537,
	MONSTER_C_SLEEPATTACK = 1538,
		
	//Magic DPS
	MONSTER_C_MAGICALATTACK = 1539,
	MONSTER_C_ENERGYDRAIN = 1540,
	MONSTER_C_DARKSTRIKE = 1541,
	MONSTER_C_DARKTHUNDER = 1542,
	MONSTER_C_EARTHQUAKE = 1543,
	MONSTER_C_EVILLAND = 1544,
	MONSTER_C_FIRESTORM = 1545,
	MONSTER_C_FLAMECROSS = 1546,
	//MONSTER_C_GROUNDDRIVE = 1547,
	MONSTER_C_RAINOFMETEOR = 1548,
	MONSTER_C_REVERBERATION = 1549,
	MONSTER_C_VENOMFOG = 1550,
	MONSTER_C_DARKBREATH = 1551,
	MONSTER_C_GRANDDARKNESS = 1552,
	MONSTER_C_GROUNDDRIVE = 1553,
	MONSTER_C_HELLBURNING = 1554,
	MONSTER_C_CANE_OF_EVIL_EYE = 1555,

	//Buff
	MONSTER_C_DEFENDER = 1556,
	MONSTER_C_MAXPAIN = 1557,
	MONSTER_C_MAGICMIRROR = 1558,
	MONSTER_C_POWERUP = 1559,
	MONSTER_C_SPEEDUP = 1560,
	MONSTER_C_AGIUP = 1561,
	MONSTER_C_STONESKIN = 1562,	
	MONSTER_C_CRITICALWOUND = 1563,
	MONSTER_C_KEEPING = 1564,
	MONSTER_C_INVINCIBLE = 1565,
	//Debuff

	MONSTER_C_SLOWCAST = 1566,
	MONSTER_C_STOP = 1567,
	//MONSTER_C_MANDRAGORA = 1568,
	//MONSTER_C_LICK = 1569,
	MONSTER_C_ALL_STAT_DOWN = 1570,
	MONSTER_C_HELLPOWER = 1571,
	MONSTER_C_LICK = 1572,
	MONSTER_C_DRAGONFEAR = 1573,
	MONSTER_C_MANDRAGORA = 1574,
	//Wide		
	MONSTER_C_WIDEBLEEDING = 1575,
	MONSTER_C_WIDECONFUSE = 1576,
	MONSTER_C_WIDECRITICALWOUND = 1577,
	MONSTER_C_WIDECURSE = 1578,
	MONSTER_C_WIDEFREEZE = 1579,
	MONSTER_C_WIDEHELLDIGNITY = 1580,
	MONSTER_C_WIDESLEEP = 1581,
	MONSTER_C_WIDESTONE = 1582,
	MONSTER_C_WIDESTUN = 1583,
	MONSTER_C_WIDEWEB = 1584,
	MONSTER_C_WIDESUCK = 1585,
		
	//ETC
	MONSTER_C_CALLSLAVE = 1586,
	MONSTER_C_KILLING_AURA = 1587,
	MONSTER_C_GRADUAL_GRAVITY = 1588,
	MONSTER_C_EXPULSION = 1589,
	MONSTER_C_CHEAL = 1590,
	MONSTER_C_ALLHEAL = 1591,
	MONSTER_C_MENTALBREAKER = 1592,
	MONSTER_C_LEASH = 1593,
	MONSTER_C_WIDELEASH = 1594,
	MONSTER_C_SELFDESTRUCTION = 1595,

	AR_C_DISABLESPELL = 1596, //passive
	AR_C_ELEMENTALIMPRINT = 1597,
	AR_C_VAPORIZEELEMENT = 1598,
	AR_C_BYPASSCAST = 1599,
	*/
